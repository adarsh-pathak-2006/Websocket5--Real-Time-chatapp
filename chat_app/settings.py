...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-+ujomc7@pjdvfi1_0c2c5v+ffxb!2$c)x^tp+1+zpc2!=i!n@)')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'False').lower() == 'true'

ALLOWED_HOSTS = ['*'] # In production, set this to your domain e.g. .onrender.com
